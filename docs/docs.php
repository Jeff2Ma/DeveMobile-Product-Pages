...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en-US">
	<head>
		...
		<title>DeveMobile 主题使用文档 | DeveWork</title><!---->
		  <meta name="keywords" content="DeveMobile,主题,使用说明,下载," />
	      <meta name="description" content="非常感谢您购买使用DeveMobile 主题，为了能让您熟练使用本主题，特开此使用文档，对常见的操作、问题等予以说明。已购买用户请详细看完本文档。本文档会不时更新。" />
	...
	<body data-spy="scroll" data-target="#docs_navigation">
					...
					<div class="bs-docs-section">
						...
						<div class="row">
							<div class="col-xs-12 col-sm-7">
								<p>非常感谢您购买使用DeveMobile 主题，为了能让您熟练使用本主题，特开此使用文档，对常见的操作、问题等予以说明。已购买用户请详细看完本文档。本文档会不时更新。</p>
						...
						<div class="page-header">
							<h1 id="before_buy">购买须知</h1>
						</div>
						<!--<h4 id="install" class="small_caption">1) Instal</h4>-->
						<h4><small>购买地址：<a target="_blank" href="http://devework.com/devemobile-theme.html#devemobile-order">http://devework.com/devemobile-theme.html</a></small></h4>
						<div class="row">
							<div class="col-xs-12">
								<p>在购买本主题前，请确保你已经了解并做好以下几点：</p>
								<ol>
									<li>本主题需要你的主机空间开启某些函数（一般主机都开启了的），具体操作<a target="_blank" href="http://pan.baidu.com/s/1bnmudav">请下载本压缩包</a>，解压后上传test 到主题根目录下，访问http://域名/test.php 查看结果；</li>
									...
									<li>主题购买后只能用于一个站点；为防止盗版，本主题具备域名授权功能，请购买前提供主题要使用在网站的域名；授权域名可以免费申请更换一次。</li>
									<li>已购买用户在产品生命期内可以免费更新升级。购买后无个性化的代码修改服务，如有额外功能需求，需额外加价进行定制。</li>
						...
						<div class="row">
							<div class="col-xs-12 col-sm-7">
								<p>菜单对于主题的左侧边栏的导航栏。建议新建一个菜单（因为并不一定是要与pc 主题的菜单相同的），菜单名字随便命名。然后拖动选择菜单的子项目，本主题只支持支持二级菜单，请自行设置。</p>
								
								<p>ps：右边的图片请忽略</p><!--<p>主题左侧导航栏的每个小图标是通过每个项目的“图像描述”来设置的（请点击左上角的“显示选项”，勾选“图像描述”），在某个项目中输入图片代码（类似icon-***），限于篇幅，本完整步骤以及视频教程请参考《》一文。</p>-->
							</div>
							<div class="col-xs-12 col-sm-5 image_container">
						...
						<div class="row">
							<div class="col-xs-12 col-sm-7">
								<p>“幻灯片”板块对应前台的首页幻灯片。虽然本主题配有幻灯片，但从移动设备加载的角度上考虑，不建议您开启该功能。如需使用，请自行按照说明使用。</p>
						...
						<p>插件下载地址：<a target="_blank" href="http://devework.com/dw-mobile-switcher.html#download">点击进入</a></p>
						...
						<div class="row">
							<div class="col-xs-12 col-sm-7">
								 ...
								 <p>特色图像优先级：输出自定义域图片地址thumb＞上传的特色图像。即使说比如你又上传了特色图像又用thumb 设置了，那么根据优先级，只会显示thumb的那个图片。</p>
							</div>
							<div class="col-xs-12 col-sm-5 image_container">
						...
						<p>主题付费用户在看完本文档后如果对一些问题还是不能解决，请联系我本人询问。</p>
						<!-- /upport -->
					</div>
				</div><!-- class="sidebar" -->
			</div><!-- class="row" -->
		...
		<script type="text/javascript" src="<?php echo $path ?>docs/js/jquery.js"></script>
		<script type="text/javascript" src="<?php echo $path ?>docs/js/bootstrap.min.js"></script>
