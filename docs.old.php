						...
						<!--<h4 id="install" class="small_caption">1) Instal</h4>-->
							...
							<!-- <div class="col-xs-12 col-sm-5 image_container">
								<a href="src/img/sh_instal.jpg"><img src="src/img/sh_instal.jpg" /></a>
												...
												<h4>主题当前售价：<strong  style="color: #ff6600;">￥109</strong></h4>

						<div class="row">
						<div class="col-xs-12">
						<h4>购买地址</h4>							
			<p><a href="http://store.devework.com/product/devemobile" target="_blank">http://store.devework.com/product/devemobile</a></p>
